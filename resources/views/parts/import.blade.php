<x-app-layout>
    <div class="max-w-4xl mx-auto space-y-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Import Parts</h1>
            <p class="text-gray-600 mt-2">Upload file Excel untuk import data parts</p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-lg border border-gray-100 p-8 space-y-6">
            <div class="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                ...
                <ul class="list-disc pl-6 text-blue-900 text-sm space-y-1">
                    <li><strong>name</strong> - Nama part (required)</li>
                    <li><strong>sku</strong> - SKU/Code (required, unique)</li>
                    <li><strong>vendor_name</strong> - Nama vendor (required)</li>
                    <li><strong>vendor_code</strong> - Kode vendor (optional)</li>
                    <li><strong>uom</strong> - Unit of Measure (optional)</li>
                    <li><strong>description</strong> - Deskripsi (optional)</li>
                </ul>
                <div class="mt-4">
                    <a href="{{ route('parts.export') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700">
            ...
            <form method="POST" action="{{ route('parts.import') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('parts.index') }}" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-semibold hover:bg-gray-200">
                        Batal
                    </a>
                </div>
            </form>
